...
namespace NightShopStockManager.Helpers.Behaviours
{
    public class EventToCommandBehavior : BehaviorBase<View>
    {
        ...
        void RegisterEvent(string name)
        {
            ...
            {
                //"normal" event with sender and eventargs parameters
                var methodInfo = typeof(EventToCommandBehavior).GetTypeInfo().GetDeclaredMethod("OnEvent");
                eventHandler = methodInfo.CreateDelegate(eventInfo.EventHandlerType, this);
            }
            else
            {
                // event with only one parameter
                var methodInfo = typeof(EventToCommandBehavior).GetTypeInfo().GetDeclaredMethod("OnEventSingle");
                eventHandler = methodInfo.CreateDelegate(eventInfo.EventHandlerType, this);
            }
        ...
        {
            OnEventImplementation(eventArgs);
        }
